...
// Parameters used for the access token update flow
const PLAID_UPDATE_ACCESS_TOKEN = process.env.PLAID_UPDATE_ACCESS_TOKEN || '';
...
app.post('/api/create_link_token', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
      ...
      if (PLAID_UPDATE_ACCESS_TOKEN !== '') {
        configs.access_token = PLAID_UPDATE_ACCESS_TOKEN;
      } else {
        configs.products = PLAID_PRODUCTS;
      }
